...
void manejarConexion(int client_socket) {
    ...
    // No es necesario cerrar el socket del cliente aquí si se va a mantener la conexión abierta.
}
...
int main() {
    ...
    server_addr.sin_addr.s_addr = inet_addr("127.0.0.1");  // Cambia a la dirección IP del servidor B
